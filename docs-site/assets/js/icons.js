...
//
// Written by gen-docs-lib.js from main-site/assets/js/icons.js.
...
//
// Identical. Inline SVG, no imports, and no network.
//
...
export function icon(name, options = {}) {
  ...
  if (!path) {
    console.warn(`[careers-gftv-docs] unknown icon: ${name}`);
    return null;
  }
