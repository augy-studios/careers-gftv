...
//
// Written by gen-docs-lib.js from main-site/api/_lib/accounts.js.
...
//
// Identical. One set of gftvhello_users rows, read the same way.
//
...
export async function findApplicantByUsername(username) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] findApplicantByUsername:', error);
    return null;
  }
...
export async function findApplicantByEmail(email) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] findApplicantByEmail:', error);
    return null;
  }
...
export async function findStaffByUsername(username) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] findStaffByUsername:', error);
    return null;
  }
...
export async function verifyRealmPassword(realm, userId, password) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] verifyRealmPassword:', error);
...
export async function consumeCode(userId, which, typed) {
  ...
  if (deleteError) {
    ...
    console.error('[careers-gftv-docs] consumeCode delete:', deleteError);
    return false;
  }
