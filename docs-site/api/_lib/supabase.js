...
//
// Written by gen-docs-lib.js from main-site/api/_lib/supabase.js.
...
//   - staff sessions are gftvjobs_docs_sessions, per 5h and migration 038
//   - Supabase requests are labelled as this application
...
export const supabase = createClient(url, serviceKey, {
  ...
  global: {
    headers: { 'x-application-name': 'careers-gftv-docs' },
  },
});
