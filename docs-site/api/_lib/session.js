...
//
// Written by gen-docs-lib.js from main-site/api/_lib/session.js.
...
export async function getApplicantSession(req) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] getApplicantSession:', error);
    return null;
  }
...
export async function getStaffSession(req) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] getStaffSession:', error);
    return null;
  }
  if (!data || !data.user) return null;
...
export async function destroySession(realm, sessionId) {
  ...
  if (error) console.error('[careers-gftv-docs] destroySession:', error);
}
...
export async function endSession(req, res, realm) {
  ...
  if (token) {
    ...
    if (error) console.error('[careers-gftv-docs] endSession:', error);
  }
...
export async function invalidateAllSessions(realm, userId, options = {}) {
  ...
  if (error) console.error('[careers-gftv-docs] invalidateAllSessions:', error);
}
...
export async function useApplicantTrustedDevice(req, res, userId) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] useApplicantTrustedDevice:', error);
    return false;
  }
...
async function rotateApplicantDevice(res, userId, rowId) {
  ...
  if (error) {
    ...
    console.error('[careers-gftv-docs] rotateApplicantDevice:', error);
    return;
  }
...
export async function trustApplicantDevice(res, userId, label = null) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] trustApplicantDevice:', error);
    return false;
  }
...
export async function renameCurrentApplicantDevice(req, userId, label) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] renameCurrentApplicantDevice:', error);
    return false;
  }
...
export async function useStaffTrustedDevice(req, res, userId) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] useStaffTrustedDevice:', error);
    return false;
  }
  if (!data) return false;
  ...
  if (updateError) {
    console.error('[careers-gftv-docs] useStaffTrustedDevice rotate:', updateError);
    return true;
  }
...
export async function trustStaffDevice(res, userId, label = null) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] trustStaffDevice:', error);
    return;
  }
...
export async function revokeAllTrustedDevices(realm, userId) {
  ...
  if (error) console.error('[careers-gftv-docs] revokeAllTrustedDevices:', error);
}
...
export async function revokeTrustedDevice(realm, userId, deviceId) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] revokeTrustedDevice:', error);
    return false;
  }
...
export async function listTrustedDevices(realm, userId) {
  ...
  if (error) {
    console.error('[careers-gftv-docs] listTrustedDevices:', error);
    return [];
  }
...
export async function hasPortalAccess(staffUser) {
  ...
  if (error) {
    ...
    console.error('[careers-gftv-docs] hasPortalAccess:', error);
    return false;
  }
