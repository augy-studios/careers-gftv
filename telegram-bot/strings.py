...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "button.docsBack": "↩️ Back to the guides",
        "button.docsPrev": "◀️ Previous",
        "button.docsNext": "Next ▶️",
        "button.docsFirst": "⏮️ First",
        "button.docsLast": "Last ⏭️",
        # The middle button of the pager, which says where the reader is. It is
        # numbers and one emoji in both languages: a label that has to sit
        # between two arrows on a phone has no room for a sentence, and a page
        # count reads the same in either language.
        "button.docsPage": "📄 {count}/{total}",
    ...
    "zh": {
        "start.intro": (
            "<b>国际兽视入队平台</b>\n\n"
            "这里是国际兽视入队平台求职网站的 Telegram 服务。关联您的求职账户后，"
        ...
        "button.docsBack": "↩️ 返回指南目录",
        "button.docsPrev": "◀️ 上一页",
        "button.docsNext": "下一页 ▶️",
        "button.docsFirst": "⏮️ 第一页",
        "button.docsLast": "最后一页 ⏭️",
        "button.docsPage": "📄 {count}/{total}",
